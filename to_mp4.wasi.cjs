...
let __wasmFilePath = __nodePath.join(__dirname, 'to_mp4.wasm32-wasi.wasm')
const __wasmDebugFilePath = __nodePath.join(__dirname, 'to_mp4.wasm32-wasi.debug.wasm')
...
module.exports.yuvToH264 = __napiModule.exports.yuvToH264
